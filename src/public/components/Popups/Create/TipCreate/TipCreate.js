...
class TipCreate extends Component{
    ...
    onCreate() {
        ...
        this.refs.closeTipCreate.addEventListener('click', () => {
    ...
    render() {
        ...
        <div class="bg-color-white v-margin-l-32px v-margin-t-32px v-margin-r-32px v-margin-b-32px" style="display: flex; align-items: center; justify-content: space-between;">
            <div class="t-lg f-w-md t-color-gray">Create Tip</div>
            <div class="t-color-gray" style="display: flex; align-items: center;">
                ...
                <div class="material-icons v-margin-r-8px" style="cursor: pointer; user-select: none;" data-ref="closeTipCreate">close</div>
            </div>
        </div>
