...
class PostCreate extends Component{
    ...
    onCreate() {
        this.refs.autoGrowingArea.addEventListener('input', event => {
        ...
        this.refs.closePostCreate.addEventListener('click', () => {
    ...
    render() {
        return `
        <div class="bg-color-white f-poppins v-border-r-32px" style="scrollbar-width: none; -ms-overflow-style: none; -webkit-scrollbar: none; max-width: 30.5rem; overflow: hidden; overflow-y: auto; max-height: 41.75rem;">
        <form>
        <div class="bg-color-white v-margin-l-32px v-margin-t-32px v-margin-r-32px v-margin-b-32px" style="display: flex; align-items: center; justify-content: space-between;">
            <div class="t-lg f-w-md t-color-gray">Create Post</div>
            <div class="t-color-gray" style="display: flex; align-items: center;">
                ...
                <div class="material-icons v-margin-r-8px" style="cursor: pointer; user-select: none;" data-ref="closePostCreate">close</div>
            </div>
        </div>
        <div class="bg-color-light-gray t-color-gray" style="border-radius: 0 0 2rem 2rem; padding: 2rem;">
            <div>
                ...
                <div>
                    ...
                    <textarea data-ref="autoGrowingArea" class="bg-color-white v-border-r-32px v-margin-b-8px text-input f-poppins t-md f-w-rg t-color-gray" placeholder="Type your post here..." style="resize: none; width: 100%; border: none; outline: none; padding: 1rem; min-height: 8rem; overflow: hidden;"></textarea>
                </div>
            </div>
            ...
            <div class="v-margin-t-16px">
                ...
                <div class="v-margin-l-64px"><label class="t-md f-w-md v-margin-r-8px" for="private-check">Private</label><input id="private-check" type="checkbox"></div></div>
