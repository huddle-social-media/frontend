...
class AvailableIssues extends Component {
    constructor(props = {}) {
        super(props);
        this.render = this.render.bind(this);
        this.onClick = this.onClick.bind(this);
        this.subscriber = this.subscriber.bind(this);
        this.setSubscriber("availableIssues", this.subscriber);
    }
        ...
        switch(action.type) {
            case reviewerTableEvents.SELECT_AVAILABLE_ISSUES: {
                if(state.sidebar.selectedSection === "Issues")
                    this.refs.availableIssues.style.display = "block";
                break;
            }
            case reviewerTableEvents.SELECT_ACCEPTED_ISSUES: {
                if(state.sidebar.selectedSection === "Issues")
                    this.refs.availableIssues.style.display = "none";
                break;
            }
            case SELECT_NEW_SECTION: {
                if(state.sidebar.selectedSection === "Issues" 
                && state.reviewerTable.selectedSection === "availableIssues")
                    this.refs.availableIssues.style.display = "block";
                else
                    this.refs.availableIssues.style.display = "none";
                break;
    ...
    render() {
        let issues = `
        <div class="issue-tbl" style="display: none" data-ref="availableIssues">
                ...
                <div class="issue-tbl__row">
                        ...
                        <div class="issue-tbl__row__expand" style="display: none">
                            ...
                            <div class="issue-tbl__row__expand__section3">
                                <div class="issue-tbl__row__expand__section3__btn issue-tbl__row__expand__section3__btn--color-green">Report</div>
